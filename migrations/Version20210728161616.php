 ...
 */
final class Version20210728161616 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE class_inter (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE class_inter_contact (class_inter_id INT NOT NULL, contact_id INT NOT NULL, INDEX IDX_3FDE8222E7A1254A (contact_id), INDEX IDX_3FDE82225C965BCE (class_inter_id), PRIMARY KEY(class_inter_id, contact_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE class_inter_groupe_contact (class_inter_id INT NOT NULL, groupe_contact_id INT NOT NULL, INDEX IDX_767365DD5F4C1496 (groupe_contact_id), INDEX IDX_767365DD5C965BCE (class_inter_id), PRIMARY KEY(class_inter_id, groupe_contact_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
