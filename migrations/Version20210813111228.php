 ...
 */
final class Version20210813111228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE alerte (id INT AUTO_INCREMENT NOT NULL, emetteur VARCHAR(255) NOT NULL, objet VARCHAR(255) NOT NULL, heure_envoi VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
