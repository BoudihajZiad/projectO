 ...
 */
final class Version20210824145300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campagne CHANGE id_user_id id_user_id INT DEFAULT NULL, CHANGE id_message_simple_id id_message_simple_id INT DEFAULT NULL, CHANGE canal canal VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE planification planification VARCHAR(255) DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE silence silence VARCHAR(255) DEFAULT NULL, CHANGE titre_message titre_message VARCHAR(255) DEFAULT NULL, CHANGE corps_message corps_message VARCHAR(255) DEFAULT NULL, CHANGE idd idd INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE destinataire_camp DROP FOREIGN KEY FK_B5E4EA76E30BE83');
        $this->addSql('DROP INDEX IDX_B5E4EA76E30BE83 ON destinataire_camp');
        $this->addSql('ALTER TABLE destinataire_camp ADD idd_campagne INT NOT NULL, DROP id_campagne_id, CHANGE id_contact_id id_contact_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE destinataire_camp ADD id_campagne_id INT DEFAULT NULL, DROP idd_campagne, CHANGE id_contact_id id_contact_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B5E4EA76E30BE83 ON destinataire_camp (id_campagne_id)');
        $this->addSql('ALTER TABLE groupe_contact CHANGE id_user_id id_user_id INT DEFAULT NULL');
