 ...
 */
final class Version20210822214139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campagne DROP FOREIGN KEY FK_539B5D1679F37AE5');
        ...
        $this->addSql('ALTER TABLE campagne ADD CONSTRAINT FK_539B5D1679F37AE5 FOREIGN KEY (id_user_id) REFERENCES client (id)');
        ...
        $this->addSql('ALTER TABLE groupe_contact ADD id_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE groupe_contact ADD CONSTRAINT FK_8A05017679F37AE5 FOREIGN KEY (id_user_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_8A05017679F37AE5 ON groupe_contact (id_user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campagne ADD CONSTRAINT FK_539B5D1679F37AE5 FOREIGN KEY (id_user_id) REFERENCES client (id) ON UPDATE CASCADE');
        $this->addSql('ALTER TABLE campagne ADD CONSTRAINT FK_539B5D1653749FB4 FOREIGN KEY (id_message_simple_id) REFERENCES message_simple (id) ON UPDATE CASCADE ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE groupe_contact DROP FOREIGN KEY FK_8A05017679F37AE5');
        $this->addSql('DROP INDEX IDX_8A05017679F37AE5 ON groupe_contact');
        $this->addSql('ALTER TABLE groupe_contact DROP id_user_id');
        ...
        $this->addSql('ALTER TABLE message_simple ADD CONSTRAINT FK_F65CA00D79F37AE5 FOREIGN KEY (id_user_id) REFERENCES client (id) ON UPDATE CASCADE ON DELETE SET NULL');
    }
}
